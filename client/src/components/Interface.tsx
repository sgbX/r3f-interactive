  ...
  const showInfo = () => {
    toast.info(
      <div className="space-y-2">
        ...
        <p>
          This application was created by sgbX to explore 3D graphics with React Three Fiber and Three.js.
          You can modify the shape properties and view the source code to see how it was implemented!
        </p>
        ...
        <div className="flex items-center gap-2">
          <div className="bg-background/85 backdrop-blur-sm px-4 py-2 rounded-lg shadow-lg border border-primary/20">
            ...
            <p className="text-sm text-muted-foreground">
              Created by sgbX, {new Date().getFullYear()}
            </p>
          </div>
        </div>
